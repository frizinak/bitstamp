...
const (
	...
	USD  generic.Currency = "usd"
	GBP  generic.Currency = "gbp"
	EUR  generic.Currency = "eur"
	PAX  generic.Currency = "pac"
	USDC generic.Currency = "usdc"
	XRP  generic.Currency = "xrp"
	LTC  generic.Currency = "ltc"
	ETH  generic.Currency = "eth"
	BCH  generic.Currency = "bch"
	XLM  generic.Currency = "xlm"
	LINK generic.Currency = "link"
	OMG  generic.Currency = "omg"
)
